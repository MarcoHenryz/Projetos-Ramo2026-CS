...
O jogo da memória foi desenvolvido utilizando HTML, CSS e JavaScript, com foco em manipulação de elementos DOM, eventos de clique e efeitos visuais de rotação das cartas.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{imgs/memoriaHtml.png}
    \caption{Estrutura HTML utilizada para organização das cartas do jogo da memória.}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{imgs/memoriaCss.png}
    \caption{Trecho da estilização CSS utilizada para posicionamento e animação das cartas.}
\end{figure}
