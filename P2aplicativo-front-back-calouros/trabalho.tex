...
Todos os membros do projeto já possuem contas ativas no GitHub. A próxima etapa consiste no treinamento da equipe quanto ao fluxo de trabalho com Git, utilizando exemplos práticos dentro do repositório oficial do projeto para fixação dos comandos de sincronização (\texttt{pull}, \texttt{commit}, \texttt{push}).
